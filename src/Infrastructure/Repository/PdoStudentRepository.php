...
class PdoStudentRepository implements StudentRepository
{
    ...
    public function allStudents(): array
    {
        ...
        return $this->hydrateSudentList($stmt);
    }
    ...
    private function hydrateSudentList(\PDOStatement $stmt) : array 
    {
    ...
    {
        $updateQuerry = 'UPDATE students SET name = :name, birth_date = :birth_date WHERE id = :id;';
        $stmt = $this->connection->prepare($updateQuerry);
